...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { location: @weather.location, time: @weather.time, week: @weather.week } }, as: :json
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { location: @weather.location, time: @weather.time, week: @weather.week } }, as: :json
    assert_response 200
  end
